...
public class StateLevel_2 extends EstadoJuego{
    ...
    public StateLevel_2(ManagerEstados ms){
        this.ms=ms;        
        this.iniciar();
    }
    ...
    public void iniciar() {    
        try {
            ...
            tilemap.cargarTiles("/assets/tileset/level2_tiles.png");
    ...
    public void level_finished()
    {
        if(player.getX()>1890)
        {
            ...
            player.setX(5);
            this.ms.setEstadoactual(0);            
            JOptionPane.showMessageDialog(new JFrame(), "Has terminado exitosamente el nivel 2, el nivel 3 está en construcción.", "¡Felicitaciones!", JOptionPane.INFORMATION_MESSAGE);       
        }
    }
